package com.miituo.atlaskm.api;
...
public class ApiClient {
    ...
    public String postDatos(String Url,String body) throws IOException
    {
        ...
        String jsonstring="";
        try {
            LogHelper.log(this.c,LogHelper.request,Url, "postDatos inicio", "","", "", "");
            URL url = new URL(UrlApi+Url);
            HttpURLConnection urlConnection=(HttpURLConnection) url.openConnection();
            urlConnection.setReadTimeout(10000);
...
//            File f1=new File(context.getFilesDir(),"poliza.pdf");
            ...
            if (status != HttpURLConnection.HTTP_OK) {
                ...
                LogHelper.log(this.c,LogHelper.request,url,"responseCode: "+status,"noPoliza:"+noPoliza, "","","");
                return null;
            }
            else
                in = c.getInputStream();
            ...
            f.close();
            res="OK";
            LogHelper.log(this.c,LogHelper.request,url,"Obteniendo archivo","",res, "noPoliza:"+noPoliza,"");
        }
        catch (Exception e){
            e.printStackTrace();
            LogHelper.log(this.c,LogHelper.request,url,"","","", "noPoliza:"+noPoliza,LogHelper.getException(e));
            res=null;
        }
        return res;
    }
...
//                throw new IOException(e.getMessage());
    ...
    public int UploadPhoto(int Type, Bitmap img,String Url,String tok, String appOdo,String lat, String lon, String cp) throws IOException
    {
        ...
        try {
            LogHelper.log(this.c,LogHelper.request,Url,"inicio subir foto","","",  "id: "+
                            IinfoClient.getInfoClientObject().getPolicies().getId()+" token: "+tok+" Type: "+Type
                            +" AppOdo: "+appOdo+" lat: "+lat+" lng: "+lon+" cp: "+cp
                    ,"");
...
//            outputStream.writeBytes(lineEnd);
            ...
            LogHelper.log(this.c,LogHelper.request,Url,"subiendo foto",o.toString(),"",  "id: "+
                    IinfoClient.getInfoClientObject().getPolicies().getId(),"");
            ...
            if (statusCode != 200) {
                ...
                in=urlConnection.getErrorStream();
                jsonstring=getStringFromInputStream(in);
                LogHelper.log(this.c,LogHelper.request,Url,"error subir foto", o.toString(),jsonstring,
                        "id: "+IinfoClient.getInfoClientObject().getPolicies().getId(),"responseCode: "+statusCode);
                try {
                    JSONObject error = new JSONObject(jsonstring);
                    throw new IOException(error.getString(("Message")));
                }
    ...
    public Boolean ConfirmOdometer(int Type,String Url,String tik) throws IOException
    {
        ...
        try {
            ...
            if (statusCode != 200) {
                ...
                jsonstring=getStringFromInputStream(in);
                try {
                    LogHelper.log(this.c,LogHelper.request,Url, "ConfirmOdometer error", sendObject.toString(),
                            jsonstring, "type: "+Type +"tik: "+tik, "");
                    JSONObject error = new JSONObject(jsonstring);
                    throw new IOException(error.getString(("Message")));
                }
                catch (JSONException ex)
                ...
                Boolean jsonstring;
                jsonstring = Boolean.parseBoolean(getStringFromInputStream(in));
                LogHelper.log(this.c,LogHelper.request,Url, "ConfirmOdometer OK", sendObject.toString(),
                        jsonstring.toString(), "type: "+Type +"tik: "+tik, "");
                return  jsonstring;
            }
        }
        catch (Exception ex){
            ex.printStackTrace();
            LogHelper.log(this.c,LogHelper.request,"ConfirmOdometer error","error al subir 1er odometro",sendObject.toString(),
    ...
    public String ConfirmReportLast(String Url,String tok) throws IOException
    {
        ...
        try {
            ...
            if (statusCode != 200) {
                ...
                jsonstring=getStringFromInputStream(in);
                try {
                    LogHelper.log(this.c,LogHelper.request,Url, "ConfirmReportLast error", sendObject.toString(),
                            jsonstring, "tok: "+tok, "");
                    JSONObject error = new JSONObject(jsonstring);
                    throw new IOException(error.getString(("Message")));
                    //return jsonstring;
                ...
                String jsonstring=getStringFromInputStream(in);
                //throw new IOException("Error al Convertir Respuesta de Error");
                LogHelper.log(this.c,LogHelper.request,Url, "ConfirmReportLast OK", sendObject.toString(),
                        jsonstring, "tok: "+tok, "");
                return jsonstring;
            }
        }
    ...
    public String ConfirmReport(String Url,String tok,boolean isCancelacion, boolean isPagar) throws IOException
    {
        ...
        try {
            ...
            if (statusCode != 200) {
                ...
                jsonstring=getStringFromInputStream(in);
                try {
                    LogHelper.log(this.c,LogHelper.request,Url, "ConfirmReport error", sendObject.toString(),
                            jsonstring, "tok: "+tok+" isCancelacion: "+isCancelacion, "");
                    JSONObject error = new JSONObject(jsonstring);
                    throw new IOException(error.getString(("Message")));
                }
                catch (JSONException ex)
                ...
                //jsonstring = Boolean.parseBoolean(getStringFromInputStream(in));
                String jsonstring=getStringFromInputStream(in);
                LogHelper.log(this.c,LogHelper.request,Url, "ConfirmReport OK", sendObject.toString(),
                        jsonstring, "tok: "+tok+" isCancelacion: "+isCancelacion, "");
                return jsonstring;
            }
        }
        catch (Exception e){
            LogHelper.log(this.c,LogHelper.request,Url,"ConfirmReport Error 2",sendObject.toString(),
                    "","tok: "+tok+" isCancelacion: "+isCancelacion,LogHelper.getException(e));
            e.printStackTrace();
            throw new IOException(e.getMessage());
        }
        finally {
    ...
    public Boolean updateToken(String Url,ClientMovil client,String tok) throws IOException
    {
        ...
        try {
            ...
            if (statusCode != 200) {
                ...
                jsonstring=getStringFromInputStream(in);
                try {
                    LogHelper.log(this.c,LogHelper.request,Url, "updateToken error", result,
                            jsonstring, "tok: "+tok, "");
                    JSONObject error = new JSONObject(jsonstring);
                    throw new IOException(error.getString(("Message")));
                }
                ...
                Boolean jsonstring;
                jsonstring = Boolean.parseBoolean(getStringFromInputStream(in));
                LogHelper.log(this.c,LogHelper.request,Url, "updateToken OK", result,
                        jsonstring.toString(), "tok: "+tok, "");
                return  jsonstring;
    ...
    public String getToken(String Url)
    {
        ...
        try {
            ...
            if (statusCode != 200) {
                ...
                jsonstring=getStringFromInputStream(in);
                try {
                    LogHelper.log(this.c,LogHelper.request,Url, "getToken error", "",
                            jsonstring, "", "");
                    JSONObject error = new JSONObject(jsonstring);
            ...
            try {
                ...
                LogHelper.log(this.c,LogHelper.request,Url, "getToken OK", "",
                        jsonstring, "", "");
                return jsonstring;
            } catch (Exception e) {
                LogHelper.log(this.c,LogHelper.request,Url, "getToken error", "",
                        jsonstring, "", LogHelper.getException(e));
                e.printStackTrace();
                return "error@"+e.getMessage();
            }finally {
                in.close();
    ...
    public List<FotosFaltantesModel> getFotosFaltantes(String Url, int idpoliza, String tok_basic) {
        ...
        try {
            ...
            LogHelper.log(this.c,LogHelper.request,Url, "getFotosFaltantes inicio", "","",
                    "id: "+idpoliza+" tok_basic: "+tok_basic, "");
            ...
            if (statusCode != 200) {
                ...
                jsonstring=getStringFromInputStream(in);
                try {
                    LogHelper.log(this.c,LogHelper.request,Url, "getFotosFaltantes error", "",
                            jsonstring, "", "");
                    JSONObject error = new JSONObject(jsonstring);
                    //throw new IOException(error.getString(("Message")));
                    return null;
                ...
                try {
                    jsonstring = getStringFromInputStream(in);
                    //Log.w("Data",jsonstring);
                    LogHelper.log(this.c,LogHelper.request,Url, "getFotosFaltantes OK", "",
                            jsonstring, "", "");
                    if (jsonstring != null || jsonstring != "") {
                        Gson parseJson = new GsonBuilder().setDateFormat("yyyy-MM-dd'T'hh:mm:ss").create();
